...
import com.example.appchatandroid.adapters.RecentConversationsAdapter;
import com.example.appchatandroid.databinding.ActivityMainBinding;
import com.example.appchatandroid.listeners.ConversionListener;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners(){
        ...
        binding.icNewChat.setOnClickListener(v ->
    ...
    private void loadUserDetails(){
     ...
     private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null){
            ...
            Collections.sort(conversations,(o1, o2) -> o1.dataObject.compareTo(o1.dataObject));
